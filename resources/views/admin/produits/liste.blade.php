...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link " href="{{ route("allCategory") }}" aria-expanded="false">
                                    ...
                                    <table class="table no-wrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th>{{ $produit->price }}</th>
                                                <th>{{ $produit->qte }}</th>
                                                <th><img src="{{ asset('uploads') }}/{{ $produit->photo }}" alt="" width="80"></th>

                                                <th><a data-bs-toggle="modal" data-bs-target="#editexampleModal{{ $produit->id }}" class="btn btn-primary">Edit</a>
                                                    <a href="/deleteProduit/{{ $produit->id }}" class="btn btn-danger">Delete</a>
                                                </th>
                                            </tr>
                                            @endforeach
                                            @else
        ...
        @foreach ($produits as $produit)
        <div class="modal fade" id="editexampleModal{{ $produit->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form action="/produit/edit" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="nom" class="col-form-label">Nom:</label>
                                <input type="text" class="form-control" value="{{ $produit->name }}" name="name">
