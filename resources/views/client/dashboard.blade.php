            ...
            <div class="col-lg-6 col-6 text-left">
                <form action="{{ route('filter') }}" method="post">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control"  id="productName" name="name" placeholder="Search for products">
                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0"
                    ...
                    <!--    <div class="nav-item dropdown">
                        ...
                        @foreach( $categorys as $category)           
                            <a href="/products/{{ $category->id }}" class="nav-item nav-link">{{ $category->name }}</a>                            
                        @endforeach
                    </div>
                </nav>
            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4" >
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            ...
                            width: 300px;
                            height: 300px;"
                            src="{{ asset('uploads') }}/{{ $produit->photo }}" alt="">
                        </div>
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3">{{ $produit->name }}</h6>
                            <input type="hidden" name="id_produit" value="{{ $produit->id }}">
                            <div class="d-flex justify-content-center">
                                <h6>{{ $produit->price }}dt</h6>
                                
                            </div>
                        </div>
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            <a href="/detailsProduct/{{ $produit->id }}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View
                                Detail</a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        ...
                        width: 300px;
                        height: 300px;"
                        src="{{ asset('uploads') }}/{{ $product->photo }}" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
